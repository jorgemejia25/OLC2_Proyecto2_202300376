...
ADD x3, x3, 1
check_digit:
atoi_convert_46131e62:
ADD x4, x0, x3
LDRB w4, [x4]
CMP w4, 0
B.eq atoi_end_e20a8c5c
SUB w5, w4, 48
CMP w5, 9
B.hi atoi_error_7f347429
CMP w5, 0
B.lt atoi_error_7f347429
// Procesando dígito
MOV x6, #10
MUL x1, x1, x6
ADD x1, x1, x5
ADD x3, x3, 1
B atoi_convert_46131e62
atoi_error_7f347429:
...
STR x0, [SP, #-8]!
LDR x0, [SP], #8
// Storing value to variable 'puntosTypeOf' at offset 64
MOV x1, #64
ADD x1, sp, x1
STR x0, [x1, #0]
// Assignment complete
...
STR x0, [SP, #-8]!
LDR x0, [SP], #8
// Storing value to variable 'puntos' at offset 168
MOV x1, #168
ADD x1, sp, x1
STR x0, [x1, #0]
// Assignment complete

...
ADD x3, x3, 1
check_digit:
atoi_convert_90d8390e:
ADD x4, x0, x3
LDRB w4, [x4]
CMP w4, 0
B.eq atoi_end_fa703584
SUB w5, w4, 48
CMP w5, 9
B.hi atoi_error_c11057c5
CMP w5, 0
B.lt atoi_error_c11057c5
// Procesando dígito
MOV x6, #10
MUL x1, x1, x6
ADD x1, x1, x5
ADD x3, x3, 1
B atoi_convert_90d8390e
atoi_error_c11057c5:
